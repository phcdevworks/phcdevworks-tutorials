module PhcdevworksTutorials
  class Tutorial::Post < ApplicationRecord
    ...
    has_and_belongs_to_many :categories, class_name: "PhcdevworksCoreModules::Post::Category", :join_table => "phcdevworks_tutorials_categories_posts", :dependent => :destroy
